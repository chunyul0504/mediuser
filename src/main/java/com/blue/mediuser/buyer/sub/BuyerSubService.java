...
public class BuyerSubService {
    ...
    public Long addBuyerIdentification(BuyerIdentificationDto buyerIdentificationDto){
        return buyerIdentificationRepository.save(buyerIdentificationDto.insertEntity()).getSeq();
    }
